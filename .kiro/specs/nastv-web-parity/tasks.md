...
- [ ] 1. 创建 FormatUtils 工具类
  - [ ] 1.1 创建 FormatUtils.java 文件，实现基础格式化方法
...
- [ ] 5. 实现 FormatUtils 流信息格式化
  - [ ] 5.1 实现视频/音频/字幕信息格式化方法
...
- [ ] 7. 创建 ProgressRecorder 播放进度记录器
  - [ ] 7.1 实现 ProgressRecorder.java
...
- [ ] 8. Checkpoint - 确保 Manager 层完成
  - 确保所有测试通过，如有问题请询问用户

- [ ] 9. 更新 MainActivity 媒体卡片
  - [ ] 9.1 修改媒体卡片布局添加评分显示
    - 在海报右上角添加评分 TextView
...
- [ ] 10. 更新 SeasonDetailActivity 剧集列表
  - [ ] 10.1 增强剧集列表项显示
    - 添加剧集缩略图 (still_path)
    - 添加剧集标题和简介
...
- [ ] 12. 创建 EpisodeDetailActivity 剧集详情页
  - [ ] 12.1 创建 EpisodeDetailActivity.java 和布局文件
    - 显示剧集标题、简介、时长、播出日期
    - 添加播放按钮
...
- [ ] 13. Checkpoint - 确保详情页完成
  - 确保所有测试通过，如有问题请询问用户

- [ ] 14. 创建 FavoriteActivity 收藏页面
  - [ ] 14.1 创建 FavoriteActivity.java 和布局文件
    - 添加标签切换 (全部/电影/电视节目)
    - 添加总数显示
...
- [ ] 15. 创建 CategoryActivity 分类列表页面
  - [ ] 15.1 创建 CategoryActivity.java 和布局文件
...
- [ ] 16. 更新 VideoPlayerActivity 播放器功能
  - [ ] 16.1 集成 ProgressRecorder
...
- [ ] 17. 更新导航和入口
  - [ ] 17.1 在 MainActivity 添加收藏入口
    - 在侧边栏或顶部添加收藏按钮
    - 点击跳转到 FavoriteActivity
    - _Requirements: 3.1_
  - [ ] 17.2 在 MainActivity 添加分类入口
    - 在侧边栏添加分类菜单
    - 点击跳转到 CategoryActivity
    - _Requirements: 4.1_
  - [ ] 17.3 更新 SeasonDetailActivity 剧集点击
    - 点击剧集跳转到 EpisodeDetailActivity
    - _Requirements: 7.1_

- [ ] 18. 完善电影详情页
  - [ ] 18.1 更新 MediaDetailActivity 电影模式
    - 添加演职人员列表
    - 添加文件信息区域
    - 添加视频技术信息区域
    - 添加 IMDB 链接
